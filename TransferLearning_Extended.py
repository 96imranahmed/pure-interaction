...
train_image_folder = os.path.join(base_folder, "dataset", "Train")
test_image_folder = os.path.join(base_folder, "dataset", "Test")
...
def train_and_eval(_base_model_file, _train_image_folder, _test_image_folder, _results_file, _new_model_file, testing = False):
    ...
    print(_base_model_file, _train_image_folder, _test_image_folder)
    ...
    trained_model = train_model(_base_model_file, feature_node_name, last_hidden_node_name,
                                ...
                                len(class_mapping), train_map_file, num_epochs=20, freeze=True)
...
def inference(img_file):
    model_file = os.path.join(os.getcwd(), "Output", "TransferLearning.model")
